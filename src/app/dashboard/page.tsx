...
import DataCollectionList from '@/components/collect/DataCollectionList';
...
export default function DashboardPage() {
  ...
  const renderActiveTab = () => {
    switch (activeTab) {
      ...
      case 'processing-demo':
        return (
          <div className="p-6 max-w-7xl mx-auto">
            <div className="glass-card p-12 text-center">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">完整流程演示</h2>
              <p className="text-gray-600 mb-6">体验完整的数据处理工作流程</p>
              <div className="space-x-4">
                <a
                  href="/complete-processing-demo"
                  className="inline-block px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
                >
                  查看完整演示
                </a>
                <a
                  href="/test-processing-flow"
