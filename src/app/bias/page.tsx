...
import { PlusOutlined, EyeOutlined, EditOutlined, DeleteOutlined, TrendingUpOutlined } from '@ant-design/icons';
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <Space size="middle">
          ...
          <Button type="link" icon={<TrendingUpOutlined />} onClick={() => handleAnalyze(record)}>
            分析
          </Button>
